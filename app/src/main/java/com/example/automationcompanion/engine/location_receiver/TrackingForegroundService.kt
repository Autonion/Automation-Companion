...
//        startForeground(1, notification)
    ...
    private fun registerGeofenceForSlot(slotId: Long) {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            val db = com.example.automationcompanion.data.db.AppDatabase.get(applicationContext)
            ...
            val g = com.google.android.gms.location.Geofence.Builder()
                            ...
                            try {
                                ...
                                fused.lastLocation.addOnSuccessListener { loc ->
                                    if (loc != null) {
                                        ...
                                        android.location.Location.distanceBetween(slot.lat, slot.lng, loc.latitude, loc.longitude, results)
                                        val dist = results[0]
