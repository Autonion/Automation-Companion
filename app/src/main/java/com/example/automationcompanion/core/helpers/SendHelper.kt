...
object SendHelper {
     ...
     */
    private fun doPerformSend(context: Context, slot: com.example.automationcompanion.data.models.Slot, sentAt: Long) {
        ...
        val canPostNotifications: Boolean = if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.TIRAMISU) {
        ...
        val canSendSms: Boolean = ContextCompat.checkSelfPermission(context, android.Manifest.permission.SEND_SMS) == PackageManager.PERMISSION_GRANTED
